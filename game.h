...
class Game {
    ...
    public:
        ...
        static void create_effect(std::string sprite, bool fade, double scale, const Coords<double>& position,
                                  std::string sound, const Vector& velocity, double angle,
                                  const Vector& angular_velocity, std::uint32_t seconds, bool line,
                                  const Coords<double>& end_point, std::string color = "white", std::string text = "",
                                  bool cloud = false);
        ...
        static void create_shot(std::uint32_t owner_index, std::string type, std::string faction,
                                std::string firing_upgrade, const Coords<double>& position, double angle,
                                std::int32_t damage_mod);
        static void create_explosion(std::string sprite, std::string sound, const Coords<double>& position,
                                     std::int32_t damage, std::string faction, bool scan = false, bool emp = false);
        ...
        static bool should_object_cast_shadow_on_planet(const std::vector<Coords<double>>& vertices,
                                                        const Planet& planet);
};
